...
export function App() {
  return (
    ...
    <header className='flex flex-col items-center'>
     ...
     <Heading size='lg' className='mt-4'>
      ...
      <Text size='lg' className='text-gray-400 mt-1'>
        Faça loguin e comece a usar!
        </Text>

    </header>

    <form className='flex flex-col items-stretch w-full max-w-[380px] mt-10 gap-4'>
      ...
      <label htmlFor="email" className='flex flex-col gap-3' >
        <Text className='font-semibold'>Digite seu password</Text>
          <TextInput.Root>
            <TextInput.Icon>
              <Lock/>
            </TextInput.Icon>
    ...
    <footer className='flex items-center flex-col mt-8 gap-4'>
